...
const Product = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      ...
      try {
        const result = await axios.get(`https://react-nodejs-ecommerce.onrender.com/api/products/slug/${slug}`);
  ...
  const { data } = await axios.get(`https://react-nodejs-ecommerce.onrender.com/api/products/${product._id}`);
